...
- Fix a couple of PHP `8.4` / `8.5` related issues ([#50](https://github.com/wanze/SeoMaestro/pull/50)) - thanks @tiefenb
...
[1.1.2]: https://github.com/wanze/SeoMaestro/releases/tag/v1.1.2
